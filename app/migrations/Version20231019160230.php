 ...
 */
final class Version20231019160230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ingredient (id INT AUTO_INCREMENT NOT NULL, ingredients_category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, kcal_per100g DOUBLE PRECISION NOT NULL, INDEX IDX_6BAF7870EC54853C (ingredients_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ingredients_category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ingredient ADD CONSTRAINT FK_6BAF7870EC54853C FOREIGN KEY (ingredients_category_id) REFERENCES ingredients_category (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredient DROP FOREIGN KEY FK_6BAF7870EC54853C');
